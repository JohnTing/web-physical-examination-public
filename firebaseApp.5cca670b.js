...
})({"394N5":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "a24dda295cca670b";
...
},{}],"4DDUW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*
signInWithEmailAndPassword(getAuth(), "hsc000@gmail.com", "hsc000")
  .then((userCredential) => {
    const user = userCredential.user;
    console.log(user.email + "is login.");
    firebaseStatus.textContent = "已連線至資料庫，可以使用。";
  ...
  .catch((error) => {
    ...
    firebaseStatus.textContent = "資料庫連線失敗";
  });
*/ parcelHelpers.export(exports, "pushData", ()=>pushData);
var _app = require("firebase/app");
// import { getAuth, signInWithEmailAndPassword } from "firebase/auth";
var _database = require("firebase/database");
const firebaseConfig = {
    apiKey: "AIzaSyAjr53uHeIDxD1uzRcnzKJyFAE6WVUlfn0",
    authDomain: "physical-examination.firebaseapp.com",
    databaseURL: "https://physical-examination-default-rtdb.asia-southeast1.firebasedatabase.app",
    projectId: "physical-examination",
    storageBucket: "physical-examination.appspot.com",
    messagingSenderId: "204950821656",
    appId: "1:204950821656:web:638bdba7e304b20c409c6d",
    measurementId: "G-SWY69F2NCT"
};
...
async function pushData(serialNumber, placeName) {
    /*
...
*/ const data = {
    ...
    await (0, _database.set)(newPostRef, {
        ...data
    }).then(()=>{
...
(0, _database.onValue)((0, _database.ref)((0, _database.getDatabase)(), "setting"), (snapshot)=>{
    const data = snapshot.val();
    console.log(data);
    const placeNames = data.places.filter((v)=>v.length > 0);
    addButton(placeNames);
}, {
    onlyOnce: true
});
...
},{}]},["394N5"], null, "parcelRequire94c2")

//# sourceMappingURL=firebaseApp.5cca670b.js.map
